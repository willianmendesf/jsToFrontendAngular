...
// Sem contexto isolado
var texto = "Hello";
console.log("1. " + texto !== '');
console.log("2. " + texto.length >= 5);
console.log("3. " + texto.length >= 5 && texto !== '');

// Com contexto isolado
var texto = "Hello";
console.log("1. " + (texto !== ""));
console.log("2. " + (texto.length >= 5));
console.log("3. " + (texto.length >= 5 && texto !== ""));
...
// Confira se uma string contém a palavra "JavaScript".
...
// Teste se uma string contém pelo menos dois espaços em branco.
let textoEspacos = "Hello World";
console.log(textoEspacos.split(" ").length >= 2);
...
// Verifique se uma variável é um array e tem pelo menos 3 elementos.
let arrayTeste = [1, 2, 3, 4];
console.log(Array.isArray(arrayTeste) && arrayTeste.length >= 3);
...
// Teste se uma string termina com a letra "o".
let terminaComO = "JavaScript";
console.log(terminaComO.endsWith("o"));
...
let funcaoTeste = () => true;
console.log(typeof funcaoTeste === "function" && funcaoTeste());
...
// Confira se uma string contém pelo menos uma letra maiúscula.
